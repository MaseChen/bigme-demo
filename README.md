...
- [docs/bigmi-proposal-alignment.md](/Users/jarason/Documents/code/bigme-demo/docs/bigmi-proposal-alignment.md)
...
- [docs/programmable-demos.md](/Users/jarason/Documents/code/bigme-demo/docs/programmable-demos.md)

## 实际应用场景 Demo

仓库还内置了一套更接近真实业务叙事的 `智能公寓` 场景。  
它的重点不是“多几个虚拟设备”，而是把“房子”抽象成一个可编程对象，把“主人回家”抽象成一个可维护、可复用的空间程序。

- 六个空间：玄关、客厅、厨房、卧室、浴室、书房
- 一个主程序：`Owner Arrives Home`
...
- [docs/apartment-owner-arrival-demo.md](/Users/jarason/Documents/code/bigme-demo/docs/apartment-owner-arrival-demo.md)
...
而 [house_program_demo.py](/Users/jarason/Documents/code/bigme-demo/appdaemon/conf/apps/house_program_demo.py) 则进一步展示：
...
- [docs/hacs-and-xiaomi.md](/Users/jarason/Documents/code/bigme-demo/docs/hacs-and-xiaomi.md)
